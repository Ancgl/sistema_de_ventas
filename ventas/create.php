                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($productos_datos as $productos_dato){
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <button class="btn btn-info" id="btn_selecionar<?php echo $id_producto;?>">Selecionar</button>
                                                                    <script>
                                                                ...
                                                                <td><img src="<?php echo $URL."/almacen/img_productos/".$productos_dato['imagen'];?>" width="50px" alt="asdf"></td>
                    ...
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" id="total_a_cancelar" style="text-align: center; background-color: #85c71aff;" class="form-control" value="<?php echo $precio_total ?>" disabled>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <script>
                                    $('#btn_guardar_venta').click(function () {
                                        ...
                                        if (total_a_cancelar == "0" || total_a_cancelar == "") {
                                            alert("No hay productos en el carrito");
                                            return;
                                        }
                                        
                                        if (parseFloat(total_pagado) < parseFloat(total_a_cancelar)) {
                                        ...
                                        function guardar_venta() {
                                            ...
                                            $.get(url, {nro_venta:nro_venta, id_cliente:id_cliente, total_a_cancelar: total_a_cancelar}, function(datos) {
                                                ...
                                                if(datos.includes("éxito") || datos.includes("exito") || datos.includes("Venta registrada")) {
                                                    setTimeout(function() {
                                                        location.reload();
                                                    }, 2000);
                                                }
