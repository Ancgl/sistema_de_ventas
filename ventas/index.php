                                            ...
                                            <tr>
                                                                            ...
                                                                            <table class="table table-bordered table-sm table-hover table-striped">
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <th style="background-color: #b4d61dff;">
                                                ...
                                                <td>
                                                    ...
                                                    <center>
                                                        ...
                                                        <a href="../factura/factura.php?id_venta=<?php echo $id_venta; ?>" target="_blank" class="btn btn-sm" style="background-color: #0db10dff; color: #000000ff;">
